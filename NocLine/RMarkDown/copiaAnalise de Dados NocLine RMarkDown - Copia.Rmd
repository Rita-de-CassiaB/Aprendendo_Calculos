...
etl.rede.view <- read.csv2("C:/Users/ritad/Desktop/Faculdade/Aprendendo_Calculos/NocLine/RStudio NocLine/etl-rede-view.csv")
...
# Testando comandos da aula
```{r}
plot(etl.cpu.view$dado_coletado, etl.ram.view$usado)
modeloNotas <- lm(etl.cpu.view$dado_coletado ~ etl.ram.view$usado)
summary(modeloNotas)
